...
take_btn = tk.Button(btn_frame, text="📷 Take Attendance", font=("Arial", 12), width=15, height=2, command=take_attendance, bg="#61afef", fg="white")
take_btn.grid(row=0, column=0, padx=10)

upload_btn = tk.Button(btn_frame, text="📤 Upload Attendance", font=("Arial", 12), width=15, height=2, command=upload_attendance, bg="#98c379", fg="white")
